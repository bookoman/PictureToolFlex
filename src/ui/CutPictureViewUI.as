	...
	public class CutPictureViewUI extends View {
		...
		protected var uiXML:XML =
			<View>
			  ...
			  <TextInput skin="png.comp.textinput" x="256" y="266" var="inputWidth" width="60" height="22"/>
			  <Label text="宽：" x="207" y="262" size="20" toolTip="输入&quot;row,col&quot;格式，算出行列拼图" align="right" width="39" height="30"/>
			  <Button label="选择图片" skin="png.comp.button" x="483" y="264" labelSize="18" var="btnChoice"/>
			  <TextInput skin="png.comp.textinput" x="377" y="266" var="inputHeight" width="60" height="22"/>
			  <Label text="高：" x="328" y="263" size="20" toolTip="输入&quot;row,col&quot;格式，算出行列拼图" align="right" width="38" height="30"/>
